...
- 32 контрастные четырёхцветные игровые палитры и разделительные контуры полигонов.
- Плавная камера `1.65×`, следующая за мячом последние три секунды и возвращающая общий план до подсветки победителя.

var RLottie = (function () {
  ...
  function initApi(callback) {
    if (apiInited) {
      ...
      if (!apiInitStarted) {
        ...
        QueryableWorkerProxy.init(new URL('tgsticker-worker.js?v=8.9-opt.44', document.baseURI).href, rlottie.WORKERS_LIMIT, function() {
          apiInited = true;
  ...
  RawPlayer.prototype.loadFromUrl = function(url) {
    ...
    var self = this;
    var workerUrl = new URL('tgsticker-worker.js?v=8.9-opt.44', document.baseURI).href;
